window.HEADER\_DATA = window.HEADER\_DATA || {}; window.HEADER\_DATA\["sc-header-config"\] = { "mod": { "sundry": \["action", "language"\], "beacon": \["user", "nav"\], "searchbar": \["type", "dynamic"\] }, "sundry": { "language": { "currentLanguage": "en\_US", "memberLanguage": \["en\_US", "zh\_CN"\], "languageLabel": \["English", "简体中文"\], "availableLanguage": \["en\_US", "zh\_CN"\] } } };

/\*!YUI-Compressor \*/ .skin-default .sc-new-header-unicorn3 { color: #333333; }

(function(){ window.HEADER\_VERSION = "20160525113436"; })();  

Hi,

*   [My Alibaba](https://i.alibaba.com/)
    *   [Message Center](https://message.alibaba.com/feedback/default.htm?routeto=inbox)
    *   [My Favorites](https://hz-favorite.alibaba.com/favorite/favorite_home.htm)
    *   Buy
    *   [Get Quotations Now](https://rfq.alibaba.com/rfq/post.htm?tracelog=header_myalibaba)
    *   [Manage Buying Requests](https://mysourcing.alibaba.com/rfq/request/rfq_manage_list.htm)
    *   [Manage Orders](http://biz.alibaba.com/generalorders/list_orders.htm)
    *   Sell
    *   [Display New Products](https://hz-productposting.alibaba.com/product/post_product_interface.htm?tracelog=newschp_nav_madp)
    *   [Manage Products](https://hz-productposting.alibaba.com/product/manage_products.htm?tracelog=newschp_nav_mamng)
    *   [Received RFQs](https://mysourcing.alibaba.com/rfq/quotation/rfq_not_quoted_manage_list.htm)

*   [For Buyers](javascript:;)
    *   Source Products & Suppliers
    *   [By Category](https://www.alibaba.com/Products?tracelog=beacon_cate_140704)
    *   [Get Quotations](https://rfq.alibaba.com/rfq/post.htm?tracelog=header_forbuyers)
    *   [Global Expo](https://globalexpo.alibaba.com/?tracelog=beacon_expo_150820)
    *   [Wholesaler](https://wholesaler.alibaba.com/)
    *   Trade Services
    *   [Trade Assurance](https://tradeassurance.alibaba.com/?tracelog=header_buyer_service_ta)
    *   [Business Identity](https://buyer.alibaba.com/bizid_buyer)
    *   [Logistics Service](https://logistics.alibaba.com/buyer.htm?tracelog=beacon_logisticsservice)
    *   [Secure Payment](https://activities.alibaba.com/alibaba/secure-payment.php?tracelog=beacon_payment_150114)
    *   [e-Credit Line](https://ecredit.alibaba.com/ecl/buyer.htm?tracelog=ecl_beacon)
    *   [Inspection Service](https://inspection.alibaba.com/?tracelog=beacon_is_140704)
    *   Community
    *   [Trade Intelligence](https://buyer.alibaba.com/intelligence?tracelog=beacon_ti_140704)
    *   [Discussion Forums](https://buyer.alibaba.com/forum?tracelog=beacon_df_140704)
    *   [Trade Answers](https://ask.alibaba.com/?tracelog=beacon_ta_140704)
*   [For Suppliers](javascript:;)
    *   [Supplier Memberships](https://seller.alibaba.com/memberships/index.html?tracelog=seller_channel_member_hp_header)
    *   [Learning Center](https://seller.alibaba.com/learningcenter?tracelog=seller_channel_lc_hp_header)
    *   [Training Center](https://seller.alibaba.com/training.htm?tracelog=seller_channel_training_hp_header)
    
    *   [AliSource](https://sourcing.alibaba.com/?tracelog=newschp_nav_narfq)
    *   [Gold Supplier](https://oak.alibaba.com/apply/upgrade_to_goldsupplier.htm?tracelog=dt_ggs) [出口海外](https://fuwu.alibaba.com/export_hand.htm?tracelog=dt_cgs) [出口全球](http://www.alibaba-tw.com/?tracelog=dt_hktwgs) [出口全球](https://hksuppliers.alibaba.com/?tracelog=dt_hktwgs)
*   [Customer Service](javascript:;)
    *   [I Am a Buyer](https://service.alibaba.com/buyer?tracelog=head)
    *   [I Am a Supplier](https://service.alibaba.com/home/to_supplier.htm?tracelog=nav_help_supplier)
    *   [I Am a New User](https://www.alibaba.com/new_user_guide_2015.html?tracelog=2015new_home_header)
    *   [Submit a Dispute](https://service.alibaba.com/complaint/center/index.htm?tracelog=oldhd_sub_dis)
    *   [Report IPR Infringement](https://legal.alibaba.com/index.htm?site_type=international&language_id=english&tracelog=nav_ipr)
    *   [Report Abuse](https://channel.alibaba.com/complaint/home.htm?tab=2)
*   [Trade Assurance](https://tradeassurance.alibaba.com/?tracelog=from_home_menu)

[Alibaba.com](https://www.alibaba.com/ "Manufacturers")

### [Categories](https://www.alibaba.com/Products)

[Get Quotations](https://rfq.alibaba.com/rfq/search_list.htm?tracelog=47609_hp_post_botton&source=searchbar)

Save 40% off your time to get quotes

[Submit Buying Request](https://mysourcing.alibaba.com/rfq/request/post_buy_request.htm?tracelog=header_action_popup_rfq&source=header)[](https://rfq.alibaba.com/rfq/search_list.htm?tracelog=47609_hp_post_botton)

  

 [Advanced Search](javascript:;)

SCHeader.J(function(){ if(typeof window.HEADER\_DATA == 'undefined'){ window.HEADER\_DATA = {}; } var config = SCHeader.J.extend(HEADER\_DATA\['sc-header-config'\]|| {}, { containerId : '#header2012' }); SCHeader.run(config); }); /\*v1 top banner for v5 unicorn3 header TMS:2052113 \*/

define('sc-new-header-unicorn3', function(require, exports) { // 模块初始化函数 exports.init = function(box, module) { // code here }; }); (function(f){var e,d,c;e=f.replace(/#/ig,"").split(",");for(var b=0,a=e.length;b<a;b++){d=document.getElementById(e\[b\]);c=d.getAttribute("data-name");seajs.use(c,function(g){g.init(d,c)})}})('#guid-1419582906243');

*   [Home](https://rule.alibaba.com/index.htm)
*   [Rules List](https://rule.alibaba.com/rule/rule_list/146.htm)
*   [Learning](https://rule.alibaba.com/rule/rule_list/148.htm)
*   [Rules Center](http://rule.alibaba.com/rc/center/index.htm)

*   [Penalty Record >](https://rule.alibaba.com/rc/center/penalty.htm)

[Agreement folder](https://rule.alibaba.com/rule/rule_list/146.htm) \> [Alibaba.com User Agreements](https://rule.alibaba.com/rule/rule_list/149.htm)

*   [Classification of Rules](https://rule.alibaba.com/rule/rule_list/948.htm)
    *   [Posting Rules](https://rule.alibaba.com/rule/rule_list/950.htm)
    *   [Trade Rules and Dispute Rules](https://rule.alibaba.com/rule/rule_list/951.htm)
    *   [General Rules](https://rule.alibaba.com/rule/rule_list/952.htm)
*   [Agreement folder](https://rule.alibaba.com/rule/rule_list/146.htm)
    *   [Alibaba.com User Agreements](https://rule.alibaba.com/rule/rule_list/149.htm)
    *   [Other Agreements](https://rule.alibaba.com/rule/rule_list/915.htm)
    *   [Agreements in French](https://rule.alibaba.com/rule/rule_list/313.htm)
    *   [Agreements in German](https://rule.alibaba.com/rule/rule_list/312.htm)
    *   [Agreements in Italian](https://rule.alibaba.com/rule/rule_list/314.htm)
    *   [Agreements in Russian](https://rule.alibaba.com/rule/rule_list/284.htm)
    *   [Agreements in Portuguese](https://rule.alibaba.com/rule/rule_list/761.htm)
    *   [Agreements in Spanish](https://rule.alibaba.com/rule/rule_list/300.htm)
    *   [Agreements in Dutch](https://rule.alibaba.com/rule/rule_list/762.htm)
*   [Announcement](https://rule.alibaba.com/rule/rule_list/147.htm)
*   [Learning](https://rule.alibaba.com/rule/rule_list/148.htm)
*   [Overdue Rules and Agreements](https://rule.alibaba.com/rule/rule_list/763.htm)

 

[< Back to list](https://rule.alibaba.com/rule/rule_list/149.htm)
...
seajs.use('//u.alicdn.com/js/6v/biz/icburules/detail/??detail.js?t=f5f06703\_d1652839f', function(detail) { detail.render(); });

/\*!YUI-Compressor \*/ .skin-default .sc-new-footer-unicorn3 { color: #333333; }
