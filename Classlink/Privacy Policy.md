...
*   Disposal of Data: ClassLink permanently deletes personal data after the termination of a contract, when no longer needed, or when advised to do so by the customer.  
