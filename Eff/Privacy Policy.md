...
**Logging:** For visitors to our website, we generally log requests to our website through a program called [cryptolog](https://www.eff.org/code/cryptolog) (cryptolog described [further below](https://www.eff.org/policy#cryptolog)) and do internal analytical logging (also described [further below](https://www.eff.org/policy#analytics)) for up to seven days from when the data was collected.
