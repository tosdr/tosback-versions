[](https://help.github.com/en)[GitHub Docs](https://help.github.com/en)

#### Explore by product

GitHub.com

[GitHub.com](https://help.github.com/en/github) [Enterprise Administrators](https://help.github.com/en/enterprise-server@3.0/admin) [GitHub Discussions](https://help.github.com/en/discussions) [GitHub Actions](https://help.github.com/en/actions) [GitHub Packages](https://help.github.com/en/packages) [Developers](https://help.github.com/en/developers) [REST API](https://help.github.com/en/rest) [GraphQL API](https://help.github.com/en/graphql) [GitHub Insights](https://help.github.com/en/enterprise-server@3.0/insights) [Education](https://help.github.com/en/education) [GitHub Desktop](https://help.github.com/en/desktop) [GitHub CLI](https://cli.github.com/manual) [Atom](https://atom.io/docs) [Electron](https://electronjs.org/docs)

English

[English](https://help.github.com/en/github/site-policy/github-terms-of-service) [简体中文 (Simplified Chinese)](https://help.github.com/cn/github/site-policy/github-terms-of-service) [日本語 (Japanese)](https://help.github.com/ja/github/site-policy/github-terms-of-service) [Español (Spanish)](https://help.github.com/es/github/site-policy/github-terms-of-service) [Português do Brasil (Portuguese)](https://help.github.com/pt/github/site-policy/github-terms-of-service)

[GitHub.com](https://help.github.com/en/github "product: GitHub.com") [Site policy](https://help.github.com/en/github/site-policy "category: Site policy") [GitHub Terms of Service](https://help.github.com/en/github/site-policy/github-terms-of-service "article: GitHub Terms of Service")
...
If you are a government User or otherwise accessing or using any GitHub Service in a government capacity, this [Government Amendment to GitHub Terms of Service](https://help.github.com/en/articles/amendment-to-github-terms-of-service-applicable-to-u-s-federal-government-users) applies to you, and you agree to its provisions.

If you have signed up for GitHub Enterprise Cloud, the [Enterprise Cloud Addendum](https://help.github.com/en/articles/github-enterprise-cloud-addendum) applies to you, and you agree to its provisions.
...
You agree that you will not under any circumstances violate our [Acceptable Use Policies](https://help.github.com/en/articles/github-acceptable-use-policies) or [Community Guidelines](https://help.github.com/en/articles/github-community-guidelines).
...
We have the right to refuse or remove any User-Generated Content that, in our sole discretion, violates any laws or [GitHub terms or policies](https://help.github.com/en/github/site-policy). User-Generated Content displayed on GitHub for mobile may be subject to mobile app stores' additional terms.
...
GitHub personnel may only access the content of your private repositories in the situations described in our [Privacy Statement](https://help.github.com/en/github/site-policy/github-privacy-statement#repository-contents).
...
Additionally, we may be [compelled by law](https://help.github.com/en/github/site-policy/github-privacy-statement#for-legal-disclosure) to disclose the contents of your private repositories.
...
If you believe that content on our website violates your copyright, please contact us in accordance with our [Digital Millennium Copyright Act Policy](https://help.github.com/en/articles/dmca-takedown-policy). If you are a copyright owner and you believe that content on GitHub violates your rights, please contact us via [our convenient DMCA form](https://github.com/contact/dmca) or by emailing copyright@github.com. There may be legal consequences for sending a false or frivolous takedown notice. Before sending a takedown request, you must consider legal uses such as fair use and licensed uses.

We will terminate the Accounts of [repeat infringers](https://help.github.com/en/articles/dmca-takedown-policy/#e-repeated-infringement) of this policy.
...
Some Service features may be subject to additional terms specific to that feature or product as set forth in the GitHub Additional Product Terms. By accessing or using the Services, you also agree to the [GitHub Additional Product Terms](https://help.github.com/en/github/site-policy/github-additional-product-terms).
...
It is your responsibility to properly cancel your Account with GitHub. You can [cancel your Account at any time](https://help.github.com/en/articles/how-do-i-cancel-my-account) by going into your Settings in the global navigation bar at the top of the screen. The Account screen provides a simple, no questions asked cancellation link. We are not able to cancel Accounts in response to an email or phone request.
...
Communications made through email or GitHub Support's messaging system will not constitute legal notice to GitHub or any of its officers, employees, agents or representatives in any situation where notice to GitHub is required by contract or any law or regulation. Legal notice to GitHub must be in writing and [served on GitHub's legal agent](https://help.github.com/en/articles/guidelines-for-legal-requests-of-user-data/#submitting-requests).
...
{"languages":\["en","cn","ja","es","pt","de"\],"versions":{"free-pro-team@latest":"dotcom","enterprise-server@3.0":"3.0","enterprise-server@2.22":"2.22","enterprise-server@2.21":"2.21","enterprise-server@2.20":"2.20","github-ae@latest":"ghae"},"nonEnterpriseDefaultVersion":"free-pro-team@latest"}