...
*   [Contact](https://kevq.uk/contact/)
*   [Blog](https://kevq.uk/blog/)
*   [Guestbook](https://kevq.uk/guestbook/)
*   [Newsletter](https://kevq.uk/newsletter/)
*   [Blogroll](https://kevq.uk/blogroll/)
*   [Search](https://kevq.uk/search/)
...
Aside from writing posts on this blog, [I also maintain a newsletter](https://kevq.uk/newsletter), but I still try to maintain your privacy while doing so. The newsletter software that I use is a self-hosted solution provided by [Sendy](https://sendy.co/?ref=uOYNZ).

If you decide you want to subscribe to my newsletter, you only need to enter an email address and hit the subscribe button. Once you have done that, you will receive an email that contains a link to confirm your subscription. I do this for 2 reasons:

1.  Is stops bots from subscribing to the list.
2.  It lets me know that you **definitely** want to be subscribed and you didn’t do it by mistake.

Once subscribed, you will receive a confirmation email. This confirmation email, and every subsequent email you receive from my newsletter service will contain an unsubscribe link.
...
My guestbook is hosted on a server that I manage and own. The only required fields when creating a guestbook entry are your name and message. However, if you decide to leave your email address you will receive a notification if/when I reply. **Your email will not be made available to other guestbook visitors.**

No data is **ever** shared with 3rd parties from the guestbook and only I have access to it.
