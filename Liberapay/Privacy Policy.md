...
The intermediaries involved in payment processing collect information for anti-fraud purposes, for example the name and IP address of the payer. Please read these documents if you want more information: [Stripe's privacy policy](https://stripe.com/privacy) and [PayPal's privacy policy](https://www.paypal.com/webapps/mpp/ua/privacy-full).
