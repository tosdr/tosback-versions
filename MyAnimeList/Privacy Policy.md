...
This Privacy Policy is applicable only to the Sites and does not extend to information collected by any other websites or applications or to the practices or procedures of companies that the Company does not control. Note that the Sites may contain links to other websites, such as ad banners linking to another website. In such cases, this Privacy Policy does not apply to information collected on that website (or other websites). We are not responsible for the privacy practices of other websites, and we recommend that you read the privacy policies of each website that you visit or application that you use.
...
The Company does not have control over, or access to the information these non-affiliated third parties may collect. Such third parties' information practices are not covered by this Privacy Policy.

If you choose to opt out of having your information used to deliver advertisements tailored to your interests, you will continue to see advertisements on the Sites, but these advertisements may not be as relevant to you.

For more information about how we use cookies and your choices, please see our [Cookie Policy](https://myanimelist.net/about/cookie_policy).

6\. Access
----------

If you choose to share personal information with us, you may update or amend this information by contacting us at [legal@mail.myanimelist.net](mailto:legal@mail.myanimelist.net). Please include in your email the name of the Site(s) to which you provided the information you wish to amend.
...
10\. Data Storage in Japan and the United States
------------------------------------------------
...
*   [Changes to Privacy Policy](#cc6)
*   [Other Important Matters](#cc7)

The What and the Why
--------------------

In the course of using our Services, you may provide us, directly and indirectly, with both personal and non-personal information. Personal information is information that can be used to identify you as an individual. Non-personal information is information that does not permit direct association with you. Both personal information and non-personal information may be used alone or in the aggregate with information collected from other users. Certain non-personal information would be considered a part of your personal information if it were combined with other identifiers (e.g., combining your zip or postal code with your street address) in a way that enables you to be identified. But the same pieces of information are considered non-personal information if they are taken alone or combined only with other non-personal information (e.g., your viewing preferences).

We describe the categories of personal information we may collect above in Section 2 of our Privacy Policy (“What information the Sites collect”). Some data we collect is necessary for enabling us to provide the registration to and usage of our Services. Below is a table further describing data we may collect and the purpose of use:

|     |     |     |
| --- | --- | --- |
| Item | Types of Data | Purpose of use |
| Basic information | *   Date of birth<br>*   Gender<br>*   E-mail address<br>*   Postal address<br>*   Nationality | To help us develop, deliver, and improve our Services, including the following aspects of our Services:<br><br>*   messaging and other communication to and with users<br>*   the creation, updating, accessing, and maintaining of lists of friends or contacts<br>*   transactions for and use of virtual currency and virtual items<br>*   social communication and user-interactive features<br>*   providing end-user support ; and<br>*   to bring you advertising that may be relevant and of interest to you and to inform you of our future offers and similar products and services. |
| Data about your account and use of Services | *   Log-in ID<br>*   Password<br>*   User ID | *   To secure and enable you to register and login to your account. |
| Data we collect with Cookies | *   Session ID<br>*   Browser ID | *   Please see our [Cookie Policy](https://myanimelist.net/about/cookie_policy) for more information about how we use cookies and your choices. |
| Payment-related information | *   PayPal payer ID<br>*   Stripe customer ID | *   In connection with payment processing when you purchase products or services. |
| Information from Third Parties | *   Facebook user ID<br>*   Google user ID<br>*   Twitter user ID<br>*   Apple user ID | *   To enable integration with social networking services and plugins. |
| IP address | *   IP　address | *   To prevent and take measures against fraud, illegal activities, infringement of our rights or interests, or breaches of our [Terms of Use](https://myanimelist.net/about/terms_of_use), and this EU Privacy Policy.<br>*   For market research purposes that support our efforts to deliver a more valuable service to our community of users, including using your information to contact you with announcements, newsletters, and promotional materials related to our Services or to offer you opportunities to participate in surveys, contests, or sweepstakes via our Services. |
| Basic Information | *   E-mail address | *   To send important notices, such as changes to our [Terms of Use](https://myanimelist.net/about/terms_of_use), this EU Privacy Policy, or other Services-specific policies. |
| Information from Third Parties | *   Facebook user ID<br>*   Google user ID<br>*   Twitter user ID<br>*   Apple user ID | *   To audit and analyze data for technical administration, to improve our Services, and for end-user communications |
| Data about your account and use of Services | *   Log-in data | *   For security and enabling basic services in the use of our Services and your account.<br>*   For general advertisement purposes and to inform you of our future offers and similar products |
| Data about your account and use of Services | *   Anime list<br>*   Manga list | *   The delivery and targeting of advertising in the Services<br>*   Tracking of advertisement fulfillment metrics in the Services<br>*   Recommending Services-related products or services of interest directly to you |

If you are in the EEA, our legal basis for collecting and using the personal information described in this EU Privacy Policy depends on the personal information we collect and the specific context in which we collect it, as we discuss above in these policies. We process your information with your consent, or because we have legitimate interests, such as:
...
### Right of Information, Correction and the Right to be Forgotten
