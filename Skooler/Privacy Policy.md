This privacy policy will explain how Skooler AS (“Skooler”) uses the personal data we collect from you when you use the mConnect (this website) and related Moodle apps for Teams tabs and channels.
