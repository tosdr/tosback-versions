...
document.getElementById('terms-contact-email-part-1').innerText = 'contact@' document.getElementById('terms-contact-email-part-2').innerText = 'womenalsoknowstuff.com'
